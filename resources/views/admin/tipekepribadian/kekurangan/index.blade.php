                     ...
                     <td class="text-center">
                        <div class="dropdown custom-dropdown">
                           ...
                           <div class="dropdown-menu" aria-labelledby="dropdownMenuLink12">
                              ...
                              <a class="dropdown-item btn btn-sm text-danger" href="{{ route('kekurangantipe.destroy', $tipe->id) }}" onclick="return confirm('Apakah Anda Yakin Menghapus Data?');">Delete</a>
                           </div>
                        </div>
                     </td>
                  </tr>
